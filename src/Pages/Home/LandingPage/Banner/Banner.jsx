        ...
        <div className="relative z-10 flex h-full items-center justify-center">
          <div className="relative w-full text-center">
            ...
            <button
              ...
              className="group mx-auto mt-12 flex h-14 w-14 cursor-pointer items-center justify-center rounded-full border border-white/50 transition-all duration-300 hover:bg-white hover:text-black"
            >
              <FiPlay
                size={15}
                strokeWidth={1}
            ...
            {/* Explore More */}
            <Link to="/movies">
              <button className="group mx-auto mt-12 flex cursor-pointer items-center justify-center border border-white/50 px-6 py-3 text-white transition-all duration-300 hover:bg-white hover:text-black">
                Explore More
              </button>
            </Link>
          </div>
      ...
      {showVideo && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 p-4">
          ...
          <button
            ...
            className="absolute right-5 top-5 z-10 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-white/30 text-white transition-all duration-300 hover:bg-white hover:text-black"
          >
            <FiX size={20} />
          </button>

          {/* Video */}
          <div className="relative aspect-video w-full max-w-5xl overflow-hidden bg-black">
            <iframe
              className="h-full w-full"
              src="https://www.youtube.com/embed/aqz-KE-bpKQ?autoplay=1"
              title="CineScope Movie Trailer"
